...
internal const val EXACT_ROUTING_FINALISTS = 1
internal const val PLACEMENT_CANDIDATES = 2
...
internal const val MAXIMUM_VIA_DUST_RISE = 14
internal const val VIA_REPEATER_LANDING_WIDTH = 2
